...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BpaDJeWg.js
...
var styles_default = "/assets/styles-k-fzORs2.css";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Multi-provider, multi-session remote control for AI coding agents. Mobile-first PWA by Sendell."
			},
			{
				name: "theme-color",
				content: "#08080a"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					theme: "dark",
					position: "top-center",
					toastOptions: { classNames: { toast: "bg-bg-elevated border border-border text-fg shadow-soft" } }
				}),
...
var $$splitComponentImporter$1 = () => import("./routes-thmaotj6.mjs");
var Route$1 = createFileRoute("/")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	head: () => ({ meta: [{ title: "Sendell Remote Control" }] })
});
var $$splitComponentImporter = () => import("./docs-DrKxSO50.mjs");
var Route = createFileRoute("/docs")({
	component: lazyRouteComponent($$splitComponentImporter, "component"),
	head: () => ({ meta: [{ title: "Architecture · Sendell Remote Control" }] })
});
